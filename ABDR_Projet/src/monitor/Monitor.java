...
/**
 * aiguilleur + trie la transaction (donne la transaction Ã  la machine ayant la plus petite ressource)
 * donne l'ordre de migration (kvdb migre les table peu utilisÃ©es vers une autre db)
